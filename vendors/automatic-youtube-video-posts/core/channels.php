...
function WP_ayvpp_channel_scripts() {
	...
	wp_enqueue_script('ayvpp-channels',get_bloginfo('wpurl').'/wp-content/plugins/viagemcultural_plugin/vendors/automatic-youtube-video-posts/js/channels.js',array('jquery'));
}
//                                *******************************                                 //
