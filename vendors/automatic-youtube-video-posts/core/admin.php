...
function WP_ayvpp_styles() {
	if(is_admin()) {
		wp_enqueue_style('ayvpp-admin',get_bloginfo('wpurl').'/wp-content/plugins/viagemcultural_plugin/vendors/automatic-youtube-video-posts/css/admin.css');
	}
	else {
		wp_enqueue_style('ayvpp-admin',get_bloginfo('wpurl').'/wp-content/plugins/viagemcultural_plugin/vendors/automatic-youtube-video-posts/css/style.css');
	}
}
function WP_ayvpp_scripts() {
	if(is_admin()) {
		wp_enqueue_script('ayvpp-admin',get_bloginfo('wpurl').'/wp-content/plugins/viagemcultural_plugin/vendors/automatic-youtube-video-posts/js/admin.js');
	}
}
